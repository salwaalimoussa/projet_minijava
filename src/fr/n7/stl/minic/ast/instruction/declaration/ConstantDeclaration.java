...
public class ConstantDeclaration implements Instruction, Declaration {
	...
	public boolean collectAndPartialResolve(HierarchicalScope<Declaration> _scope) {
		if (_scope.accepts(this)) {
			...
			Logger.error("Constant " + this.name + " is already declared in this scope.");
			return false;
		}
	}
	...
	public boolean checkType() {
		...
		if (this.type.equals(tval)) {
			return true;
		} else {
			Logger.error("Type mismatch in constant declaration: expected " + this.type + ", but found " + tval);
			return false;
		}
	}
	...
	public int allocateMemory(Register _register, int _offset) {
		// Constants do not allocate memory since their values are directly embedded
		// in the code.
		return _offset;
	}
