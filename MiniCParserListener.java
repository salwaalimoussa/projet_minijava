...
public interface MiniCParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterInstructionArrayDeclaration(MiniCParser.InstructionArrayDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code instructionArrayDeclaration}
	 * labeled alternative in {@link MiniCParser#instruction}.
	 * @param ctx the parse tree
	 */
	void exitInstructionArrayDeclaration(MiniCParser.InstructionArrayDeclarationContext ctx);
	/**
